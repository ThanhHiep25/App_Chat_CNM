...
const Infor = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      unsubscribe(); // Stop listening for updates when the component unmounts
      setUserData(null); // Clear user data when leaving the screen
    };
  }, [db, userId2.uid]);
  ...
  return (
    <div className="infor-fr">
      ...
      <div className="edit-infor">
        <button className="btn-edit-infor" onClick={handleEditProfile}>
